...
export const bibleBooks: BibleBook[] = [
  ...
  { abbr: '1KI', number: 11, englishName: '1 Kings', arabicName: 'ملوك الأول', germanName: '1. Könige', chapters: 22 },
  { abbr: '2KI', number: 12, englishName: '2 Kings', arabicName: 'ملوك الثاني', germanName: '2. Könige', chapters: 25 },
  ...
  { abbr: 'PSA', number: 19, englishName: 'Psalms', arabicName: 'مزمور', germanName: 'Psalm', chapters: 150 },
  ...
  { abbr: 'SNG', number: 22, englishName: 'Song of Songs', arabicName: 'نشيد الإنشاد', germanName: 'Hohelied', chapters: 8 },
  ...
  { abbr: 'HAG', number: 37, englishName: 'Haggai', arabicName: 'حجي', germanName: 'Haggai', chapters: 2 },
  ...
  { abbr: 'MAT', number: 40, englishName: 'Matthew', arabicName: 'إنجيل متى', germanName: 'Matthäus', chapters: 28 },
  { abbr: 'MRK', number: 41, englishName: 'Mark', arabicName: 'إنجيل مرقس', germanName: 'Markus', chapters: 16 },
  { abbr: 'LUK', number: 42, englishName: 'Luke', arabicName: 'إنجيل لوقا', germanName: 'Lukas', chapters: 24 },
  { abbr: 'JHN', number: 43, englishName: 'John', arabicName: 'إنجيل يوحنا', germanName: 'Johannes', chapters: 21 },
  { abbr: 'ACT', number: 44, englishName: 'Acts', arabicName: 'أعمال', germanName: 'Apostelgeschichte', chapters: 28 },
  ...
  { abbr: 'REV', number: 66, englishName: 'Revelation', arabicName:  'رؤيا يوحنا', germanName: 'Offenbarung', chapters: 22 },
];
